...
public class HospitalController {
	...
	@Autowired
	public RegisterService register1;
	@Autowired
...
//		register.ah();
	...
	public ResponseEntity<Hospital> hello1(HttpEntity<String> httpEntity) {
		System.out.println("inside");
		System.out.println(dao1.getHospitalDetails("arpitlall20@gmail.com"));
		return new ResponseEntity<Hospital>(dao1.getHospitalDetails("arpit test"),HttpStatus.OK);
	}
